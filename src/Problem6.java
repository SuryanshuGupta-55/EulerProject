...
class Problem6 {
    ...
    public static void main(String args[]) throws IOException {
        ...
        int n = 100;
        long mod = 1000000007;
        // A variable to calculate sum of first n natural numbers.
        long sumfirst = (n*(n+1))/2;
        long squarefirst = ((sumfirst%mod)*(sumfirst%mod))%mod;
//       A variable to store square of first n nautral numbers.
        long squarefirstsum = (n*(n+1) * (2*n+1))/6;
        println(squarefirst-squarefirstsum+"");
        bw.flush();
        bw.close();
    }
